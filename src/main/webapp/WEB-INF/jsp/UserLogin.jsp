...
<!-- Mirrored from themesdesign.in/upcube/layouts/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 26 Oct 2024 14:10:21 GMT -->
<head>
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <a class="form-label ms-1" href="registrationForm" for="customCheck1">Register Here</a>
                                        </div>
                                    </div>
                                </div>
